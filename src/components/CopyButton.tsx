...
export default function CopyButton({ text, className = '' }: CopyButtonProps) {
  ...
  return (
    <button
      ...
      onClick={handleCopy}
      className={`group inline-flex items-center justify-center h-7 w-7 px-1 py-1 rounded-full border-primary bg-white text-lg ${className} hover:bg-primary transition-colors duration-300`}
    >
      {copied ? (
        ...
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-primary group-hover:text-white transition-colors" viewBox="0 0 640 640" fill="currentColor"> 
